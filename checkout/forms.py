...
class OrderForm(forms.ModelForm):
    ...
    def clean_full_name(self):
        ...
        if not all(x.isalpha() or x.isspace() for x in full_name):
            ...
            ("Full name should contain only alphabetical characters. E.g. 'John Doe' ")
        return full_name
    ...
    def clean_city(self):
        ...
        if not all(x.isalpha() or x.isspace() for x in city):
            raise forms.ValidationError
            ("City should contain only alphabetical characters. E.g. 'Stockholm' ")
        return city
    ...
    def clean_county(self):
        ...
        if county is not None and not all(x.isalpha() or x.isspace() for x in county):
            raise forms.ValidationError
            ("County should contain only alphabetical characters. E.g. 'Stockholm Lan' ")
        return county
